...
function handleOpenAIEvent(clientSocket, aiSocket, event) {
  ...
  switch (event.type) {
    ...
    case "response.audio_transcript.done":
      logger.log(clientSocket.id, `[Audio Transcript Done] ${extractTranscriptText(event.transcript)}`);
    ...
    case "conversation.item.input_audio_transcription.completed":
      logger.log(clientSocket.id, `[Input Audio Transcription Completed] ${extractTranscriptText(event.transcript)}`);
